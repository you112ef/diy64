...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-600 dark:text-gray-400 border-b border-gray-100 dark:border-gray-800/50">
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-3 space-y-2">
            <div className="flex gap-1.5">
              <a
                href="/"
                className="flex-1 flex gap-1.5 items-center bg-purple-50 dark:bg-purple-500/10 text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-500/20 rounded-lg px-3 py-1.5 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  'flex gap-1 items-center rounded-lg px-2.5 py-1.5 transition-colors',
                  selectionMode
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-gray-900 relative pl-8 pr-2.5 py-1.5 rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-500/50 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-800"
                type="search"
                  ...
                  <>
                    <div className="p-4 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <div className="mt-2 max-h-28 overflow-auto border border-gray-100 dark:border-gray-800 rounded-md bg-gray-50 dark:bg-gray-900 p-2">
